    ...
    return (
        ...
        <div className="homeBtnDiv">
            ...
            <form onSubmit={e => handleSubmit(e)}>
                ...
                <div>
                    <input type='text' placeholder="Min height(cm)" value={input.heightMin} name='heightMin' onChange={e => handleChange(e)} />
                    {errors.heightMin && (
                        <p className='error'><strong>{errors.heightMin}</strong></p>
                    )}
                </div>
                <div>
                    <input type='text' placeholder="Max height(cm)" value={input.heightMax} name='heightMax' onChange={e => handleChange(e)} />
                    {errors.heightMax && (
                        <p className='error'><strong>{errors.heightMax}</strong></p>
                    )}
                </div>
                <div>
                    <input type='text' placeholder="Min weight(kg)" value={input.weightMin} name='weightMin' onChange={e => handleChange(e)} />
                    {errors.weightMin && (
                        <p className='error'><strong>{errors.weightMin}</strong></p>
                    )}
                </div>
                <div>
                    <input type='text' placeholder="Max weight(kg)" value={input.weightMax} name='weightMax' onChange={e => handleChange(e)} />
                    {errors.weightMax && (
                        <p className='error'><strong>{errors.weightMax}</strong></p>
                    )}
                </div>
                <div>
                    <input type='text'placeholder="Life span(years)" value={input.life_span} name='life_span' onChange={e => handleChange(e)} />
                    {errors.life_span && (
                        <p className='error'><strong>{errors.life_span}</strong></p>
                    )}
                </div>
                <div>
                    <input type='text' placeholder="Image url" value={input.image} name='image' onChange={e => handleChange(e)} />
                </div>
                <div>
                ...
                <button className="btnCreate" type='submit'>Create Breed❗❗</button>
